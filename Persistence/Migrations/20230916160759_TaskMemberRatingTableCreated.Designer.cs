...
namespace Persistence.Migrations
{
    ...
    [Migration("20230916160759_TaskMemberRatingTableCreated")]
    partial class TaskMemberRatingTableCreated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.DataModels.Complaints.Region", b =>
                {
                    b.Property<int>("intId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.DataModels.Notifications.NotificationToken", b =>
                {
                    b.Property<int>("intId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.DataModels.Complaints.Complaint", b =>
                {
                    ...
                    b.HasOne("Domain.DataModels.Complaints.Region", "Region")
                        .WithMany()
                        .HasForeignKey("intRegionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
