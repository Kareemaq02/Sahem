...
class BottomNavBar1 extends StatefulWidget {
 int selectedIcon;
   BottomNavBar1( this.selectedIcon) ;
      ...
      child: Column(
        children: [
          ...
          Expanded(
            child: Text(text,
                style:
                    const TextStyle(color: Colors.grey, fontSize: 8.5)),
          )
        ],
      ),
    );
    ...
    return IntrinsicHeight(
      child: Container(
        ...
        padding: const EdgeInsets.only(
            top: 12, left: 5, right: 5, bottom: 0),
          ...
          children: [
            _bottomNavBarItem(
                onTap: () => _changeSelectedTab(0),
                 icona: widget.selectedIcon==0? const Icon(Icons.home,color:AppColor.main,size: 23,): const Icon(Icons.home,color:Colors.grey,size:1,),
                text: "الصفحة الرئيسية",),
                
            _bottomNavBarItem(
                onTap: () => _changeSelectedTab(1),
                 icona: widget.selectedIcon==1? const Icon(Icons.map_outlined,color:AppColor.main,size: 23,): const Icon(Icons.map_outlined,color:Colors.grey,size: 23,),
                text: "الخريطة"),
            const SizedBox(),
            _bottomNavBarItem(
            ...
            _bottomNavBarItem(
                ...
                icona: widget.selectedIcon==3? const Icon(Icons.account_circle_outlined,color:AppColor.main,size: 23,): const Icon(Icons.account_circle_outlined,color:Colors.grey,size: 23,),
                text: "الصفحة الشخصية"),
          ],
        ),
      ),
    ...
    return Stack(
      ...
      children: [
        ...
        InkWell(
         ...
         decoration:DesignWidget().myBoxDecorationWithOutBorder(color:  AppColor.main,circular: 100),
