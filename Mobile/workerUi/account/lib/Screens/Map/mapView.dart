...
import 'package:account/Widgets/Map/marker.dart';
import 'package:account/Widgets/Map/mapCard.dart';
import 'package:account/Repository/mapLinks.dart';
import 'package:account/Widgets/Bars/appBar.dart';
import 'package:account/Widgets/Bars/bottomNavBar.dart';
import 'package:account/Widgets/Map/myLocationWidget.dart';
...
class FullMapState extends State<FullMap1> with TickerProviderStateMixin {
  ...
  void _updateMarkerSize(var zoom) {
    ...
    setState(() {
      _markerSize = markerSizeTween.transform(
          (zoom - 15) / 10.0); 
    });
  }
